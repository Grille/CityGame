...
Enums{ 
  ...
  gmode{ not=0, all=1, foCu=2, foEn=3, cuEn=4, fo=5, cu=6, en=7, st=8}//fork curve end
...
//	<---- Road ---->
 ...
 ID-21 {
  ...
  groundNeighbors = [21,22,23,24,25,26]; 
 ...
 ID-25:1 {
  ...
  ID-26:25 {
  name = "wood bridge"; 
  structNeighbors = [21,22,23,24,26]; 
